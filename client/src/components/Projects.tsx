...
export default function Projects() {
  ...
  const prev = () => setLightbox((p) => (p !== null ? (p - 1 + projectImages.length) % projectImages.length : null));
  const next = () => setLightbox((p) => (p !== null ? (p + 1) % projectImages.length : null));

  return (
    <section id="projects" className="py-24 bg-[#0D2137] relative overflow-hidden">
      {/* Decorative */}
      ...
      <AnimatePresence>
        {lightbox !== null && (
          ...
          >
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white/50 text-sm font-[family-name:var(--font-body)]">
